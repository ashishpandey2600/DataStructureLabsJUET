// 1. Write a program that creates a text file “TEXT.txt”on the disk. 
//Write text on this file. Read this file and display the following information on the screen in two columns:
//  Number of lines
//  Number of words
...
int main()
{
    ...
    fout.close();
    fin.open("TEXT.txt"); //open and count no.of lines
